...
1. data -- папка с данными:
    * CAUSE -- подпапка с данными по смертности по причинам смерти
        * RUS_m_short_idr.csv -- данные в .csv формате для 2000 года
        * rus2019causes.csv -- данные в .csv формате для 2019 года
    ...
    * WPP_e0.rds -- данные по ОПЖ для стран мира от WPP UN (2024)
2. plots -- папка с графиками (в том числе с невошедшими в основной текст)

________

* MAIN.R -- R-скрипт для репликации
